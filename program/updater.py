...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة سورس المستر......`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس [Ξ𝗠𝗥_𝗫™ المستر](https://t.me/MUSTAR_X8)", disable_web_page_preview=True)
